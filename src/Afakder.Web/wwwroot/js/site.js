  ...
  if (volunteerForm) {
    volunteerForm.addEventListener('submit', (e) => {
      ...
      if (validateForm(volunteerForm)) {
        showModal(
          'Başvurunuz Alındı!',
          'Gönüllü başvurunuz başarıyla alınmıştır. En kısa sürede sizinle iletişime geçeceğiz. Birlikte daha güçlüyüz!'
        );
        volunteerForm.reset();
      }
    });
    ...
    contactForm.addEventListener('submit', (e) => {
      ...
      if (validateForm(contactForm)) {
        showModal(
          ...
          'Mesajınızı aldık, en kısa sürede size dönüş yapacağız. İlginiz için teşekkür ederiz.'
        );
        contactForm.reset();
      }
    });
